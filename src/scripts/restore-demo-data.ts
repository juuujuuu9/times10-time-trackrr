...
async function restoreDemoData() {
  try {
    ...
    console.log(`- Multiple task assignments created`);
    console.log(`- Multiple time entries created`);
    ...
    console.log('John: john@times10.com / password123');
    console.log('Sarah: sarah@times10.com / password123');
